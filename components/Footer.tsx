...
const Footer = () => {
  return (
    <footer className={`${footerStyles.footer} flex flex-col`}>
      <div className="flex justify-evenly w-full">
        ...
        <div>
          ...
          <ul
            className={`flex flex-col text-base ${footerStyles.childHover} text-left`}
          >
            <li>
      ...
      <div className="w-full text-center pb-0 mb-0 px-10 pt-5">
        <p>Copyright © {new Date().getFullYear()} Somnath Prasad. All rights reserved.</p>
      </div>
    </footer>
  );
};
